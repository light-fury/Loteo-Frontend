...
import "./apolloLotteryContent.scss";

const ApolloLotteryContent = () => {
    ...
    return (
        <div className="apolloLottery-section">
            <Grid className="apolloLottery-section__content" wrap noPadding noWidth justify="space-between">
                <Grid wrap noWidth justify="center" className="currencies">
                    <div className="apolloLottery-section__content__currencies">
                        <div className="start">
                    ...
                    <div className="apolloLottery-section__content__chart">
...
export default ApolloLotteryContent;
